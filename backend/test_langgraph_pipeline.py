...
if __name__ == "__main__":
    ...
    assert result_submission['retrieval_status'] in ('success', 'partial_success')
    print('retrieval_status:', result_submission['retrieval_status'])
    if 'retrieval_response' in result_submission and result_submission['retrieval_response'].get('result'):
        policy_data = result_submission['retrieval_response']['result'].get('policy_data', {})
        print('Retrieved Policy Number:', policy_data.get('policy_number'))
        print('Retrieved Customer ID:', policy_data.get('customer_id'))
    ...
    assert result_policy['retrieval_status'] in ('success', 'partial_success')
